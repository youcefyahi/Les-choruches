          ...
          <div class="space-y-3">
            ...
            <div>
              ...
              <p class="text-gray-900 flex items-center">
                <svg v-if="registre.marquee" class="w-4 h-4 text-green-500 mr-2" fill="currentColor"
                  viewBox="0 0 20 20">
        ...
        <div class="bg-white rounded-lg shadow">
          <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
              ...
              <button @click="openObservationModal" class="text-yellow-600 hover:text-yellow-700 text-sm font-medium">
                + Ajouter
              </button>
              <!-- Modal Observation -->
              <ObservationModal :is-open="isObservationModalOpen" :registre-id="registreId"
                @close="closeObservationModal" @observation-added="onObservationAdded" />
            </div>
          </div>
          <div class="p-6">
...
function closeObservationModal() {
  isObservationModalOpen.value = false
}
